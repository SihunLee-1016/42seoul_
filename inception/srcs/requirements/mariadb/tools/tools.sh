...
if [ ! -d "/var/lib/mysql/mysql" ]; then
    ...
    mysql -e "CREATE USER ${MARIADB_USER_NAME}@'wordpress.inception_docker-network' IDENTIFIED BY '${MARIADB_USER_PASSWD}';"
    mysql -e "GRANT ALL PRIVILEGES ON ${MARIADB_DB_NAME}.* TO ${MARIADB_USER_NAME}@'wordpress.inception_docker-network';"
