...
void	Form::set_name(const std::string str)
{
	*(const_cast<std::string*>(&this->_name)) = str;
}

void	Form::set_sg(const int num)
{
	*(const_cast<int*>(&this->sign_g)) = num;
}

void	Form::set_eg(const int num)
{
	*(const_cast<int*>(&this->exe_g)) = num;
}
